	...
	if($requestMethod == 'POST'){
		if(!empty($data)){
            ...
            while($i < count($data)){
                ...
                $visitor .= "('$number','$name','$company','$toVisit','$purposeVisit','$visitDate','$vaccineDose1','$vaccineDose2','$doseDate1','$doseDate2','$atk','$atkDate','$status', '$timelineJson','$fdatetime','')$comma";
                $i++;
            }

            $insertVisitor = "INSERT INTO t_visitor (number, name, company, toVisit, purposeVisit, visitDate, vaccineDose1, vaccineDose2, doseDate1, doseDate2, atk, atkDate, status, timeline, datetime, note) VALUES $visitor ;";
